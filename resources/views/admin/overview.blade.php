    ...
    <div class="bottom-grid">
        ...
        <div class="right-col">
            ...
            <div class="card">
                ...
                @php
                    $evColor = $event->severity === 'DANGER' ? 'var(--danger)' : ($event->severity === 'WARNING' ? 'var(--warn)' : 'var(--water)');
                @endphp
                <div class="event-item">
                    <div class="ev-dot-wrap">
                        <div class="ev-dot" style="background:{{ $evColor }}"></div>
                    </div>
                    <div style="flex:1">
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'TX-01 Lereng Nagrak',
                    data: @json($tx01->pluck('tilt_angle')->toArray()),
                    borderColor: '#2563eb', backgroundColor: 'rgba(37,99,235,.06)',
                    borderWidth: 2, pointRadius: 3, pointHoverRadius: 5,
                    fill: true, tension: .4,
                },
                {
                    label: 'TX-02 Talagaherang',
                    data: @json($tx02->pluck('tilt_angle')->toArray()),
                    borderColor: '#059669', backgroundColor: 'rgba(5,150,105,.06)',
                    borderWidth: 2, pointRadius: 3, pointHoverRadius: 5,
                    fill: true, tension: .4,
                },
                {
                    label: 'TX-03 Bojongsawah',
                    data: @json($tx03->pluck('tilt_angle')->toArray()),
        ...
        options: {
            ...
            plugins: {
                legend: { position: 'bottom', labels: { font: { family: 'Plus Jakarta Sans', size: 11 }, boxWidth: 10, padding: 16 } },
            ...
            scales: {
                ...
                y: {
                    ...
                    title: { display: true, text: 'Kemiringan (°)', font: { size: 10 }, color: '#9ca3af' }
                }
            }
        }
    });
